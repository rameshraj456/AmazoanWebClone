      ...
      <nav>
        <div className="left">
          ...
          <div className="navlogo">
            <NavLink to='/'><img src="./h&hpng.png" alt="" />
            </NavLink>
          </div >
        ...
        <div className="right">
          ...
          </div>
          {
            account ? <Avatar className='avtar2'
              ...
              onClick={handleClick}>{account.fname ? account.fname[0].toUpperCase() : ""}</Avatar> :
